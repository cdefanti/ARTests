...
// slightly modified version of https://gist.github.com/CESARDELATORRE/6d7f647b29e55fdc219ee1fd2babb260 from .NET docs
...
public sealed class RetryWithExponentialBackoff {
    ...
    public async Task RunAsync(Func<Task> func) {
        ...
        try {
            ...
            Debug.Log("Exception raised is: " + ex.GetType().ToString() + " -- Message: " + ex.Message + " -- Inner Message: " + ex.InnerException.Message);
            await backoff.Delay();
            goto retry;
        }
    }
